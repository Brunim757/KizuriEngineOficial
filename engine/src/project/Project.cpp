...
static void WriteSourceTemplate(const fs::path& sourceDir) {
    ...
    cmake <<
        ...
        "#\n"
        "# Adiciona a RAIZ do repo (não só engine/): as dependências\n"
        ...
        "# ficam desligados; o que importa pra este build é só a KizuriEngine\n"
        "# (e este GameModule).\n"
