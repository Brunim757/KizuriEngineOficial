...
## 🚧 v0.41+ — Roadmap AAA completo (backlog de capacidade)

> Itens extraídos do docs/ROADMAP_AAA.md — o que falta pra engine
...
- [ ] 🌍 Pessoas pedestres (NPCs animados com Fox-style skeleton) — precisa de sistema de navmesh + wander AI
...
- [ ] Film grain/vignete por presets
